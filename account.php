...
<div class="row">
<div class="col-lg-6">
<span class="logo"><H2>MAT 152 ACTIVITIES</H2></span></div>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>Details</b></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="account.php?q=2"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;History</a></li>
			...
			<li><a href="http://mat152.lovestoblog.com/index.php" target="">Back Home Page</a></li>
...
<div class="col-md-6">
<form role="form" method="post" action="admin.php?q=index0.php">
<div class="form-group">
